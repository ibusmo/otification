...
- (UIView *)containView:(UIView *)view
{
    ...
    // TODO: - move placeholderview origin.y
    // frame.origin.y = ((containerView.bounds.size.height - frame.size.height) / 2.0) + 10.0;
    view.frame = frame;
...
- (void)updateNumberOfVisibleItems
{
    ...
    switch (_type)
    {
        ...
        case iCarouselTypeCylinder:
        {
            ...
            CGFloat width = _vertical ? self.bounds.size.height: self.bounds.size.width;
            CGFloat itemWidth = _itemWidth * spacing;
            _numberOfVisibleItems = ceil(width / itemWidth) + 2; // [self circularCarouselItemCount];
             */
            _numberOfVisibleItems = ([self circularCarouselItemCount] / 2.0);
            break;
        }
        case iCarouselTypeInvertedRotary:
        case iCarouselTypeInvertedCylinder:
